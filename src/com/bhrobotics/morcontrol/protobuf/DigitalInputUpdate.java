...
public class DigitalInputUpdate extends AbstractOutputWriter {
	...
	private DigitalInputUpdate(final Builder builder) {
	...
	public static class Builder {
		...
		public DigitalInputUpdate build() {
			return new DigitalInputUpdate(this);
		}
	}
	...
	static DigitalInputUpdate parseFields(final InputReader reader) throws IOException {
		int nextFieldNumber = getNextFieldNumber(reader);
		final DigitalInputUpdate.Builder builder = DigitalInputUpdate.newBuilder();
	...
	public static void setUnknownTagHandler(final UnknownTagHandler unknownTagHandler) {
		DigitalInputUpdate.unknownTagHandler = unknownTagHandler;
	}

	public static DigitalInputUpdate parseFrom(final byte[] data) throws IOException {
		return parseFields(new InputReader(data, unknownTagHandler));
	}

	public static DigitalInputUpdate parseFrom(final InputStream inputStream) throws IOException {
		return parseFields(new InputReader(inputStream, unknownTagHandler));
	}

	public static DigitalInputUpdate parseDelimitedFrom(final InputStream inputStream) throws IOException {
