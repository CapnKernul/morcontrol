...
public class AnalogInputUpdate extends AbstractOutputWriter {
	...
	private AnalogInputUpdate(final Builder builder) {
	...
	public static class Builder {
		...
		public AnalogInputUpdate build() {
			return new AnalogInputUpdate(this);
		}
	}
	...
	static AnalogInputUpdate parseFields(final InputReader reader) throws IOException {
		int nextFieldNumber = getNextFieldNumber(reader);
		final AnalogInputUpdate.Builder builder = AnalogInputUpdate.newBuilder();
	...
	public static void setUnknownTagHandler(final UnknownTagHandler unknownTagHandler) {
		AnalogInputUpdate.unknownTagHandler = unknownTagHandler;
	}

	public static AnalogInputUpdate parseFrom(final byte[] data) throws IOException {
		return parseFields(new InputReader(data, unknownTagHandler));
	}

	public static AnalogInputUpdate parseFrom(final InputStream inputStream) throws IOException {
		return parseFields(new InputReader(inputStream, unknownTagHandler));
	}

	public static AnalogInputUpdate parseDelimitedFrom(final InputStream inputStream) throws IOException {
