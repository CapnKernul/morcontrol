...
public class Service implements Iface {
    private Robot competitionRobot;
    private OutputDevices outputDevices;
    private InputDevices inputDevices;

    public Service(Robot robot) {
	competitionRobot = robot;
	outputDevices = robot.getOutputDevices();
	inputDevices = robot.getInputDevices();
    }

    public RobotMode getMode() throws TException {
	return toThriftRobotMode(competitionRobot.getMode());
    }
