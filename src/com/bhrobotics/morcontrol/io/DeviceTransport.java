...
public class DeviceTransport {
	...
	public static class Processor implements TProcessor {
		...
		private class updateRelay implements ProcessFunction {
			public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException {
				...
				} catch (InvalidAddressException errorLocations) {
	...
	public static class getMode_args implements TBase {
		...
		public int compareTo(Object otherObject) {
			...
			getMode_args other = (getMode_args) otherObject;
	...
	public static class getMode_result implements TBase {
		...
		public getMode_result(RobotMode success) {
			this();
		...
		public int compareTo(Object otherObject) {
			...
			getMode_result other = (getMode_result) otherObject;
			int lastComparison = 0;
	...
	public static class initializeEncoder_args implements TBase {
		...
		public initializeEncoder_args(Address address, Address addressOne, Address addressTwo) {
			this();
		...
		/**
		 * Returns true if field addressOne is set (has been assigned a value)
		 * and false otherwise
		 */
		...
		/**
		 * Returns true if field addressTwo is set (has been assigned a value)
		 * and false otherwise
		 */
		...
		public int compareTo(Object otherObject) {
			...
			initializeEncoder_args other = (initializeEncoder_args) otherObject;
			int lastComparison = 0;
	...
	public static class initializeEncoder_result implements TBase {
		...
		public initializeEncoder_result(InvalidAddressException error) {
			this();
			this.error = error;
		}
		...
		/**
		 * Returns true if field error is set (has been assigned a value) and
		 * false otherwise
		 */
		...
		public int compareTo(Object otherObject) {
			...
			initializeEncoder_result other = (initializeEncoder_result) otherObject;
			int lastComparison = 0;
	...
	public static class updatePWM_args implements TBase {
		...
		public updatePWM_args(Address address, int state) {
			this();
			this.address = address;
			this.state = state;
			setStateIsSet(true);
		...
		/**
		 * Returns true if field state is set (has been assigned a value) and
		 * false otherwise
		 */
		...
		public int compareTo(Object otherObject) {
			...
			updatePWM_args other = (updatePWM_args) otherObject;
			int lastComparison = 0;
	...
	public static class updatePWM_result implements TBase {
		...
		public updatePWM_result(InvalidAddressException errorLocation, InvalidStateException errorState) {
			this();
		...
		/**
		 * Returns true if field errorLocation is set (has been assigned a
		...
		/**
		 * Returns true if field errorState is set (has been assigned a value)
		 * and false otherwise
		 */
		...
		public int compareTo(Object otherObject) {
			...
			updatePWM_result other = (updatePWM_result) otherObject;
			int lastComparison = 0;
	...
	public static class updateRelay_args implements TBase {
		...
		public updateRelay_args(Address address, RelayState state) {
			this();
			this.address = address;
			this.state = state;
		}
		...
		public int compareTo(Object otherObject) {
			...
			updateRelay_args other = (updateRelay_args) otherObject;
			int lastComparison = 0;
	...
	public static class updateRelay_result implements TBase {
		...
		private static final TField ERROR_LOCATIONS_FIELD_DESC = new TField("errorLocations", TType.STRUCT, (short) 1);

		private InvalidAddressException errorLocations;
		...
		public updateRelay_result(InvalidAddressException errorLocations) {
			this();
		...
		public updateRelay_result(updateRelay_result other) {
			if (other.isSetErrorLocations()) {
				this.errorLocations = new InvalidAddressException(other.errorLocations);
			}
		}
		...
		public InvalidAddressException getErrorLocations() {
			return this.errorLocations;
		}

		public void setErrorLocations(InvalidAddressException errorLocations) {
			this.errorLocations = errorLocations;
		}

		public void unsetErrorLocations() {
			this.errorLocations = null;
		}

		/**
		 * Returns true if field errorLocations is set (has been assigned a
		 * value) and false otherwise
		 */
		public boolean isSetErrorLocations() {
			return this.errorLocations != null;
		}

		public void setErrorLocationsIsSet(boolean value) {
			if (!value) {
				this.errorLocations = null;
			}
		}
		...
		public boolean equals(updateRelay_result that) {
			...
			boolean this_present_errorLocations = true && this.isSetErrorLocations();
			boolean that_present_errorLocations = true && that.isSetErrorLocations();
			if (this_present_errorLocations || that_present_errorLocations) {
				if (!(this_present_errorLocations && that_present_errorLocations))
					return false;
				if (!this.errorLocations.equals(that.errorLocations))
					return false;
			}
		...
		public int compareTo(Object otherObject) {
			...
			updateRelay_result other = (updateRelay_result) otherObject;
			int lastComparison = 0;

			lastComparison = TBaseHelper.compareTo(isSetErrorLocations(), other.isSetErrorLocations());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetErrorLocations()) {
				lastComparison = this.errorLocations.compareTo(other.errorLocations);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
		...
		public void read(TProtocol iprot) throws TException {
			...
			while (true) {
				...
				switch (field.id) {
				case 1: // ERROR_LOCATIONS
					if (field.type == TType.STRUCT) {
						this.errorLocations = new InvalidAddressException();
						this.errorLocations.read(iprot);
					} else {
						TProtocolUtil.skip(iprot, field.type);
					}
					break;
		...
		public void write(TProtocol oprot) throws TException {
			...
			if (this.isSetErrorLocations()) {
				oprot.writeFieldBegin(ERROR_LOCATIONS_FIELD_DESC);
				this.errorLocations.write(oprot);
				oprot.writeFieldEnd();
			}
			oprot.writeFieldStop();
			oprot.writeStructEnd();
		...
		public String toString() {
			...
			sb.append("errorLocations:");
			if (this.errorLocations == null) {
				sb.append("null");
			} else {
				sb.append(this.errorLocations);
			}
			first = false;
			sb.append(")");
			return sb.toString();
	...
	public static class updateSolenoid_args implements TBase {
		...
		public updateSolenoid_args(Address address, boolean state) {
			this();
			this.address = address;
			this.state = state;
			setStateIsSet(true);
		...
		public int compareTo(Object otherObject) {
			...
			updateSolenoid_args other = (updateSolenoid_args) otherObject;
			int lastComparison = 0;
	...
	public static class updateSolenoid_result implements TBase {
		...
		public updateSolenoid_result(InvalidAddressException error) {
			this();
			this.error = error;
		}
		...
		public int compareTo(Object otherObject) {
			...
			updateSolenoid_result other = (updateSolenoid_result) otherObject;
			int lastComparison = 0;
	...
	public static class getPWM_args implements TBase {
		...
		public getPWM_args(Address address) {
			this();
			this.address = address;
		}
		...
		public int compareTo(Object otherObject) {
			...
			getPWM_args other = (getPWM_args) otherObject;
			int lastComparison = 0;
	...
	public static class getPWM_result implements TBase {
		...
		public getPWM_result(int success, InvalidAddressException error) {
			this();
			this.success = success;
		...
		public int compareTo(Object otherObject) {
			...
			getPWM_result other = (getPWM_result) otherObject;
			int lastComparison = 0;
	...
	public static class getRelay_args implements TBase {
		...
		public getRelay_args(Address address) {
			this();
			this.address = address;
		}
		...
		public int compareTo(Object otherObject) {
			...
			getRelay_args other = (getRelay_args) otherObject;
			int lastComparison = 0;
	...
	public static class getRelay_result implements TBase {
		...
		public getRelay_result(RelayState success, InvalidAddressException error) {
			this();
			this.success = success;
			this.error = error;
		}
		...
		public int compareTo(Object otherObject) {
			...
			getRelay_result other = (getRelay_result) otherObject;
			int lastComparison = 0;
	...
	public static class getSolenid_args implements TBase {
		...
		public getSolenid_args(Address address) {
			this();
			this.address = address;
		}
		...
		public int compareTo(Object otherObject) {
			...
			getSolenid_args other = (getSolenid_args) otherObject;
			int lastComparison = 0;
	...
	public static class getSolenid_result implements TBase {
		...
		public getSolenid_result(boolean success, InvalidAddressException error) {
			this();
			this.success = success;
			setSuccessIsSet(true);
			this.error = error;
		...
		public int compareTo(Object otherObject) {
			...
			getSolenid_result other = (getSolenid_result) otherObject;
			int lastComparison = 0;
	...
	public static class getDigitalInput_args implements TBase {
		...
		public getDigitalInput_args(Address address) {
			this();
			this.address = address;
		}
		...
		public int compareTo(Object otherObject) {
			...
			getDigitalInput_args other = (getDigitalInput_args) otherObject;
			int lastComparison = 0;
	...
	public static class getDigitalInput_result implements TBase {
		...
		public getDigitalInput_result(boolean success, InvalidAddressException error) {
			this();
			this.success = success;
			setSuccessIsSet(true);
			this.error = error;
		...
		public int compareTo(Object otherObject) {
			...
			getDigitalInput_result other = (getDigitalInput_result) otherObject;
			int lastComparison = 0;
	...
	public static class getAnalogInput_args implements TBase {
		...
		public getAnalogInput_args(Address address) {
			this();
			this.address = address;
		}
		...
		public int compareTo(Object otherObject) {
			...
			getAnalogInput_args other = (getAnalogInput_args) otherObject;
			int lastComparison = 0;
	...
	public static class getAnalogInput_result implements TBase {
		...
		public getAnalogInput_result(double success, InvalidAddressException error) {
			this();
			this.success = success;
			setSuccessIsSet(true);
			this.error = error;
		...
		public int compareTo(Object otherObject) {
			...
			getAnalogInput_result other = (getAnalogInput_result) otherObject;
			int lastComparison = 0;
	...
	public static class getEncoder_args implements TBase {
		...
		public getEncoder_args(Address addressOne, EncoderCommand command) {
			this();
			this.addressOne = addressOne;
		...
		public int compareTo(Object otherObject) {
			...
			getEncoder_args other = (getEncoder_args) otherObject;
			int lastComparison = 0;
	...
	public static class getEncoder_result implements TBase {
		...
		public getEncoder_result(double success, InvalidAddressException errorLocation, InvalidCommandException errorCommand) {
			this();
			this.success = success;
			setSuccessIsSet(true);
			this.errorLocation = errorLocation;
		...
		/**
		 * Returns true if field errorCommand is set (has been assigned a value)
		 * and false otherwise
		 */
		...
		public int compareTo(Object otherObject) {
			...
			getEncoder_result other = (getEncoder_result) otherObject;
			int lastComparison = 0;
