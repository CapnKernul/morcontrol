...
public abstract class AbstractMessageSerializer {
	public static final String GROUP_SEPARATOR = new String(OIConnection.GROUP_SEPARATOR_BYTES);
	public static final String RECORD_SEPARATOR = new String(OIConnection.RECORD_SEPARATOR_BYTES);
	public static final String UNIT_SEPARATOR = new String(OIConnection.UNIT_SEPARATOR_BYTES);
