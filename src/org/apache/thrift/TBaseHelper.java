...
public class TBaseHelper {
    ...
    /*
     * public static int compareTo(List a, List b) { int lastComparison =
     * compareTo(a.size(), b.size()); if (lastComparison != 0) { return
     * lastComparison; } for (int i = 0; i < a.size(); i++) { Object oA =
     * a.get(i); Object oB = b.get(i); if (oA instanceof List) { lastComparison
     * = compareTo((List) oA, (List) oB); } else { lastComparison =
     * compareTo((Comparable) oA, (Comparable) oB); } if (lastComparison != 0) {
